...
//Deleting row with  click of Delete button
...
function enableSubmit(){
  ...
  if(enableButton) {
    ...
    //Calling function to remove EDIT and DELETE from header if none of the rows are selected
    this.removeHeadings();


    //Adding Disabling feauture to Submit Button if no rows are selected
